...
carsClass1Indizes =  intersect( find(carClasses == 1),trainIndizes);
carsClass2Indizes  = intersect( find(carClasses == 2),trainIndizes);
carsClass3Indizes  = intersect( find(carClasses == 3),trainIndizes);
carsClass4Indizes  = intersect( find(carClasses == 4),trainIndizes);
carsClass5Indizes  = intersect( find(carClasses == 5),trainIndizes); 
carsClass6Indizes  = intersect( find(carClasses == 6),trainIndizes);
carsClass7Indizes  = intersect( find(carClasses == 7),trainIndizes);
carsClass8Indizes  = intersect( find(carClasses == 8),trainIndizes);
carsClass9Indizes  = intersect( find(carClasses == 9),trainIndizes);
...
p1 = L1 / length(trainIndizes);
p2 = L2 / length(trainIndizes);
p3 = L3 / length(trainIndizes);
p4 = L4 / length(trainIndizes);
p5 = L5 / length(trainIndizes);
p6 = L6 / length(trainIndizes);
p7 = L7 / length(trainIndizes);
p8 = L8 / length(trainIndizes);
p9 = L9 / length(trainIndizes);
...
testCarClasses = carClasses(testIndizes);
retestClasses = zeros(1,length(testCarClasses));
% Classifikation
for i=1:length(testCarClasses)
    x = imageFeatures(testIndizes(i),:)';
...
error = sum(abs(retestClasses(1,1:length(testCarClasses)) - testCarClasses) > 0) / length(testCarClasses)
